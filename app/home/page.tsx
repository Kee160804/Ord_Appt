...
// import {
//   Sparkles, Calendar, ShoppingBag, ArrowRight, Check,
//   Zap, Shield, Globe, BarChart3, Users, ChevronRight
// } from "lucide-react";
...
//       {/* ── Navbar ────────────────────────────────────────────── */}
//       <nav className="flex items-center justify-between px-6 md:px-12 py-5 border-b border-white/5 sticky top-0 z-50 bg-[#070b14]/90 backdrop-blur-xl">
...
//           </div>
//           <span className="font-black text-white text-lg tracking-tight">LocalSpace</span>
//         </div>
...
//           <Link href="/login"
//             className="text-sm font-semibold text-slate-400 hover:text-white px-4 py-2 rounded-xl hover:bg-white/5 transition-colors">
//             Sign In
//           </Link>
//           <Link href="/register"
//             className="text-sm font-bold text-white bg-violet-600 hover:bg-violet-500 px-4 py-2 rounded-xl transition-colors shadow-sm shadow-violet-900/30">
//             Get Started Free
//           </Link>
//         </div>
//       </nav>
...
//         <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-violet-500/10 border border-violet-500/20 text-violet-300 text-xs font-bold rounded-full mb-8">
...
//           <Link href="/register"
//             className="inline-flex items-center gap-2 px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-2xl transition-colors shadow-lg shadow-violet-900/30 text-base">
//             Start free trial <ArrowRight className="w-5 h-5" />
//           </Link>
//           <Link href="/login"
//             className="inline-flex items-center gap-2 px-8 py-4 border border-white/10 hover:border-white/20 text-slate-300 hover:text-white font-bold rounded-2xl transition-colors text-base">
//             View Demo Dashboard
//           </Link>
//         </div>

//         <p className="text-sm text-slate-600 mt-5">No credit card required · 14-day free trial</p>
//       </section>

//       {/* ── Business Types ────────────────────────────────────── */}
//       <section className="max-w-6xl mx-auto px-6 md:px-12 pb-24">
//         <div className="grid md:grid-cols-2 gap-6">
//           <div className="bg-violet-900/20 border border-violet-500/20 rounded-3xl p-8 hover:border-violet-500/40 transition-colors">
//             <div className="w-12 h-12 bg-violet-500/20 rounded-2xl flex items-center justify-center mb-5">
//               <Calendar className="w-6 h-6 text-violet-400" />
//             </div>
//             <h3 className="text-xl font-black text-white mb-2">Appointment Businesses</h3>
...
//                 <span key={e} className="text-xs font-semibold px-3 py-1.5 bg-violet-500/10 border border-violet-500/20 rounded-full text-violet-300">{e}</span>
//               ))}
//             </div>
//           </div>

//           <div className="bg-orange-900/20 border border-orange-500/20 rounded-3xl p-8 hover:border-orange-500/40 transition-colors">
//             <div className="w-12 h-12 bg-orange-500/20 rounded-2xl flex items-center justify-center mb-5">
//               <ShoppingBag className="w-6 h-6 text-orange-400" />
//             </div>
//             <h3 className="text-xl font-black text-white mb-2">Ordering Businesses</h3>
//             <p className="text-slate-400 text-sm mb-5">
...
//                 <span key={e} className="text-xs font-semibold px-3 py-1.5 bg-orange-500/10 border border-orange-500/20 rounded-full text-orange-300">{e}</span>
//               ))}
//             </div>
//           </div>
//         </div>
...
//       {/* ── Features ──────────────────────────────────────────── */}
//       <section id="features" className="bg-slate-900/40 border-y border-white/5 py-24">
//         <div className="max-w-6xl mx-auto px-6 md:px-12">
//           <div className="text-center mb-16">
//             <h2 className="text-3xl md:text-4xl font-black text-white mb-3">Everything your business needs</h2>
//             <p className="text-slate-400 text-lg">All the tools. One platform. Zero setup headaches.</p>
//           </div>
...
//               return (
//                 <div key={f.title}
//                   className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 hover:border-violet-500/30 hover:bg-slate-800 transition-all group">
...
//             <h2 className="text-3xl md:text-4xl font-black text-white mb-3">See it live</h2>
//             <p className="text-slate-400">Real business storefronts — built on LocalSpace</p>
//           </div>

//           <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
//             {demos.map(d => (
//               <Link key={d.slug} href={`/store/${d.slug}`}
//                 className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 hover:border-slate-500 hover:-translate-y-1 transition-all group text-center space-y-4">
//                 <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl mx-auto shadow-lg"
...
//                   {d.type}
//                 </span>
//                 <div className="flex items-center justify-center gap-1 text-xs text-slate-500 group-hover:text-slate-300 transition-colors">
...
//       {/* ── Pricing ───────────────────────────────────────────── */}
//       <section id="pricing" className="bg-slate-900/40 border-y border-white/5 py-24">
...
//             {plans.map(p => (
//               <div key={p.name}
//                 className={`relative bg-slate-800/60 border-2 ${p.color} rounded-3xl p-8 ${p.badge ? "md:-mt-4 md:pb-12" : ""}`}>
//                 {p.badge && (
...
//                   </div>
//                 )}
//                 <p className="font-bold text-slate-400 text-sm mb-2">{p.name}</p>
...
//       {/* ── CTA ───────────────────────────────────────────────── */}
//       <section className="py-20 bg-gradient-to-r from-violet-900/40 to-indigo-900/40 border-y border-violet-500/20">
//         <div className="max-w-3xl mx-auto px-6 text-center">
//           <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Ready to grow your business?</h2>
//           <p className="text-slate-400 mb-8">Join thousands of local businesses already using LocalSpace.</p>
//           <Link href="/register"
//             className="inline-flex items-center gap-2 px-8 py-4 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-2xl transition-colors shadow-lg shadow-violet-900/30">
...
//             </div>
//             <span className="font-black text-white">LocalSpace</span>
//           </div>

...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: "Track revenue, bookings, and customer trends all in one dashboard.",
    },
    {
      icon: Globe,
      title: "Your Own Storefront",
      desc: "Each business gets a branded public page — no coding required.",
    },
    {
      icon: Shield,
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-violet-900/20 light:bg-violet-50 border border-violet-500/20 light:border-violet-200 rounded-3xl p-8 hover:border-violet-500/40 light:hover:border-violet-300 transition-colors">
            ...
            <p className="text-slate-400 light:text-gray-600 text-sm mb-5">
              ...
              deposits, and confirmations effortlessly.
            </p>
          ...
          <div className="bg-orange-900/20 light:bg-orange-50 border border-orange-500/20 light:border-orange-200 rounded-3xl p-8 hover:border-orange-500/40 light:hover:border-orange-300 transition-colors">
            ...
            <p className="text-slate-400 light:text-gray-600 text-sm mb-5">
              ...
              inventory, and fulfilment all in one place.
            </p>
            <div className="flex flex-wrap gap-2">
              {[
                "Restaurants",
            ...
            {features.map((f) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-white light:text-gray-900 mb-2">
                    {f.title}
                  </h3>
                  <p className="text-sm text-slate-400 light:text-gray-600 leading-relaxed">
                    {f.desc}
                  </p>
                </div>
              );
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {demos.map((d) => (
              ...
              >
                ...
                <div>
                  <p className="font-bold text-white light:text-gray-900 text-sm">
                    {d.name}
                  </p>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div key={s.label}>
                <p className="text-4xl font-black text-white light:text-gray-900 mb-2">
                  {s.value}
                </p>

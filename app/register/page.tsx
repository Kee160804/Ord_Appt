...
export default function RegisterPage() {
  ...
  const submit = async () => {
    ...
    if (result.success) {
      ...
      // Give the auth provider one frame to persist the new session.
        ...
        <div className="rounded-2xl border border-slate-700/50 bg-slate-800/60 p-5 shadow-xl shadow-black/30 sm:p-8">
          ...
          {step === 1 && (
            <div className="space-y-5 animate-fade-in">
              <div>
                <h2 className="text-lg font-black text-white">Yuh account</h2>
          ...
          {step === 2 && (
            <div className="space-y-5 animate-fade-in">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                {[
                  {
                    type: "appointment" as BusinessType,
                    icon: Calendar,
                    label: "Appointments",
                    desc: "Salons, barbers, clinics, studios",
                    color: "violet",
                    examples: [
                      "💅 Nail salons",
                      "💈 Barbershops",
                  ...
                  return (
                    <button
                      key={opt.type}
                      onClick={() => setBType(opt.type)}
                      className={cn(
                        "p-5 rounded-2xl border-2 text-left space-y-3 transition-all",
                        sel
                          ? isViolet
          ...
          {step === 3 && (
            <div className="space-y-5 animate-fade-in">
              <div>
                <h2 className="text-lg font-black text-white">
                  Yuh business details
                </h2>
                <p className="text-sm text-slate-500 mt-0.5">
                  Your public storefront information
                </p>
              </div>
              <Field
                label="Business Name"
              ...
              <div>
                ...
                <div className="flex min-w-0 items-center">
                  <span className="text-sm text-slate-500 bg-slate-700/50 border border-slate-600 rounded-l-xl px-3 py-2.5 border-r-0 whitespace-nowrap">
                    YuhBusiness.io/
                  </span>
                  <input
                    value={form.slug}
              ...
              <div className="p-4 bg-violet-900/20 border border-violet-500/20 rounded-xl text-sm text-violet-300">
                ...
                <p className="text-violet-400/70">
                  ...
                  {bType === "appointment"
                    ? "appointment booking"
                    : "online ordering"}{" "}
                  storefront will be live instantly after signup.
                </p>
                <p className="mt-2 text-violet-300">
                  Your 14-day free trial begins when this business is created.

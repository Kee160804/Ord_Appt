...
//             className="pl-9 pr-4 py-2 text-sm bg-white border border-slate-200 rounded-xl w-52
//                        focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-300 transition" />
//         </div>
//       </div>

//       <Card>
//         <div className="px-6 py-3 grid grid-cols-4 gap-4 border-b border-slate-50">
//           <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider col-span-2">Customer</p>
//           <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Last Activity</p>
//           <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider text-right">Total Spend</p>
//         </div>
//         <div className="divide-y divide-slate-50">
//           {customers.map((c, i) => (
//             <div key={i} className="px-6 py-4 grid grid-cols-4 gap-4 items-center hover:bg-slate-50 transition-colors">
...
//                 </div>
//               </div>
//               <p className="text-sm text-slate-600">{formatDate(c.lastActivity)}</p>
//               <p className="text-sm font-bold text-slate-900 text-right">{formatCurrency(c.total)}</p>
//             </div>
//           ))}
//         </div>
//       </Card>

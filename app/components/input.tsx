...
//       <input
//         className={cn(
//           "w-full px-4 py-2.5 text-sm border border-slate-200 rounded-xl bg-white",
...
//       <textarea
//         className={cn(
//           "w-full px-4 py-2.5 text-sm border border-slate-200 rounded-xl bg-white resize-none",
//           "focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-400",
//           "placeholder:text-slate-400 transition",

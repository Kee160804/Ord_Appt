...
export function Input({ label, error, className, ...rest }: InputProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <input
        className={cn(
          "w-full px-3 py-2.5 text-sm border border-slate-600 light:border-[#dfe5ee] rounded-lg bg-slate-700/50 light:bg-white text-white light:text-slate-900",
...
export function Textarea({ label, error, className, ...rest }: TextareaProps) {
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <textarea
        className={cn(
          "w-full px-3 py-2.5 text-sm border border-slate-600 light:border-[#dfe5ee] rounded-lg bg-slate-700/50 light:bg-white text-white light:text-slate-900 resize-none",
          "focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-500",
          "placeholder:text-slate-500 transition",

...
//           <div
//             key={s.label}
//             className={cn("rounded-2xl p-4", s.color.split(" ")[0])}
//           >
//             <p className="text-xs font-medium text-slate-500">{s.label}</p>
//             <p
//               className={cn("text-3xl font-black mt-1", s.color.split(" ")[1])}
//             >
//               {s.value}
//             </p>
//           </div>
...
//             >
//               {/* Date badge */}
//               <div className="w-11 h-11 rounded-xl bg-violet-100 flex flex-col items-center justify-center flex-shrink-0">
...
//               <h4 className="font-bold text-violet-900 text-base">

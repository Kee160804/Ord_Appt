...
export default function TeamInvitationPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#070b14] text-white light:bg-white light:text-slate-900">
      ...
      <div className="pwa-page-safe flex flex-1 items-center justify-center px-4 py-8">
        <main className="w-full max-w-md">
          <section className="rounded-3xl border border-slate-700 bg-slate-900/70 p-5 shadow-2xl light:border-slate-200 light:bg-white sm:p-7">
            ...
            {confirmationSent ? (
              <div className="mt-6 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-5 text-sm leading-6 text-emerald-100 light:text-emerald-800">
                ...
                <p className="mt-2">
                  Confirm your email using the link we sent. You will return
                  here automatically to finish joining the business.
                </p>
              </div>
            ) : (
              <>
          ...
          <p className="mt-5 text-center text-[11px] leading-5 text-slate-500">
            Invitation access is controlled by the business owner and protected
            by YuhBusiness tenant permissions. By creating or using an account,
            you agree to the <Link href="/terms">Terms of Service</Link> and

...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[#070b14] text-white light:bg-white light:text-slate-900">
      ...
      <div className="pwa-page-safe flex flex-1 items-center justify-center p-3 sm:p-4">
          ...
          {complete ? (
            <div className="text-center">
              ...
              <p className="mt-3 text-sm text-slate-400 light:text-slate-600">
                Your recovery session has been closed. Sign in again using your
                new password.
              </p>
              <Link
                href="/login?passwordUpdated=1"
                className="mt-7 inline-flex rounded-xl bg-violet-600 px-5 py-3 text-sm font-bold text-white hover:bg-violet-500"
              >
                Continue to sign in
              </Link>
            </div>
            ...
            <>
              ...
              {isChecking ? (
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <label className="block text-sm font-semibold">
                    ...
                    <input
                      ...
                      onKeyDown={(event) =>
                        event.key === "Enter" && void savePassword()
                      }
                ...
                <Link
                  ...
                  className="mt-6 inline-flex rounded-xl bg-violet-600 px-5 py-3 text-sm font-bold text-white hover:bg-violet-500"
                >
